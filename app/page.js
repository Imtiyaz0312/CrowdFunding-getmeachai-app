	...
	return (
		<>
			<div className="flex justify-center flex-col gap-4 items-center h-[40vh] text-white">
				<div className="flex items-center gap-4 font-bold text-3xl">Buy Me a Chai <span><Image width={50} height={50} className="w-20 animate-[wiggle_1s_ease-in-out_infinite]" src="/icons/tea.png" alt="Tea Image" /></span></div>
			...
			<div className=" text-white container mx-auto py-10">
				...
				<div className="flex flex-col justify-around items-center w-full gap-5">
					...
					<div className="item space-y-3 flex flex-col items-center">
						<div className=" bg-slate-600 rounded-full p-6"><Image width={50} height={50} className="w-32" src="/icons/man.png" alt="" /></div>
					...
					<div className="item space-y-3 flex flex-col items-center">
						<div className=" bg-slate-600 rounded-full p-6"><Image width={50} height={50} className="w-32" src="/icons/coin.png" alt="" /></div>
						<p className="w-2/3 text-center font-semibold">Fund Yourself</p>
						<p className="w-2/3 text-center"> Your fans are available for you to help you</p>
					</div>

					<div className="item space-y-3 flex flex-col items-center">
						<div className=" bg-slate-600 rounded-full p-6"><Image width={50} height={50} className="w-32" src="/icons/fund.png" alt="" /></div>
